...
class ComfortLevel extends StatelessWidget {
  ...
  const ComfortLevel({super.key, required this.weatherCurrent});
                ...
                RichText(
                  ...
                  children: [
                   const TextSpan(text: "Feels Like: ",
                    style:  TextStyle(
                      fontSize: 14,height: 0.8, color: CustomColors.textColorBlack,
                      fontWeight: FontWeight.w400,
                      
                    )
                    ),
                     TextSpan(text: "${weatherCurrent.current.feelsLike}",
                  ...
                  children: [
                   const TextSpan(text: "UV Index: ",
                    style:  TextStyle(
                     ...
                     TextSpan(text: "${weatherCurrent.current.uvIndex}",
                    style: const TextStyle(
                      fontSize: 14,height: 0.8, color: CustomColors.textColorBlack,
                      fontWeight: FontWeight.w400,
